#ifndef _API2PYTHON_ROS_H_
#define _API2PYTHON_ROS_H
...
#include "api2python/utils.h"
#include "api2python/api_info.h"

namespace api2python
{
class API2PythonROS : public nav_core::BaseLocalPlanner
{
public:
  /**
...
private:
  ...
  ros::ServiceClient python_client;
  api2python::api_info srv;
