#ifndef PARTICIPANT_GAME_LATTICE_PLANNER_PARTICIPANT_GAME_LATTICE_PLANNER_ROS_H
#define PARTICIPANT_GAME_LATTICE_PLANNER_PARTICIPANT_GAME_LATTICE_PLANNER_ROS_H
#include <ros/ros.h>
...
{
class ParticipantGameLatticeROS : public nav_core::BaseLocalPlanner
{
public:
  /**
   * @brief Default constructor of the bezier local planner plugin
   */
  ParticipantGameLatticeROS();

  /**
   * @brief  Destructor of the plugin
   */
  virtual ~ParticipantGameLatticeROS();

  /**
   * @brief Initializes the bezier local planner plugin
  ...
  /**
   * @brief Set the plan that the bezier local planner is following
...
private:
  ...
  BezierConfig cfg_;
  ParticipantGameLattice* planner_;
};

}  // namespace participant_game_lattice

#endif  // PARTICIPANT_GAME_LATTICE_PLANNER_PARTICIPANT_GAME_LATTICE_PLANNER_ROS_H