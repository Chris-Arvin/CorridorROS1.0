#ifndef TIME_BOUNDED_LATTICE_PLANNER_TIME_BOUNDED_LATTICE_PLANNER_ROS_H
#define TIME_BOUNDED_LATTICE_PLANNER_TIME_BOUNDED_LATTICE_PLANNER_ROS_H
#include <ros/ros.h>
...
// time-bounded lattice local planner
#include "time_bounded_lattice/utils.h"
#include "time_bounded_lattice/time_bounded_lattice.h"

namespace time_bounded_lattice
{
class TimeBoundedLatticeROS : public nav_core::BaseLocalPlanner
{
public:
  /**
   * @brief Default constructor of the time-bounded lattice local planner plugin
   */
  TimeBoundedLatticeROS();

  /**
   * @brief  Destructor of the plugin
   */
  virtual ~TimeBoundedLatticeROS();

  /**
   * @brief Initializes the time-bounded lattice local planner plugin
  ...
  /**
   * @brief Set the plan that the time-bounded lattice local planner is following
...
private:
  ...
  BezierConfig cfg_;
  TimeBoundedLattice* planner_;
};

}  // namespace time_bounded_lattice

#endif  // TIME_BOUNDED_LATTICE_PLANNER_TIME_BOUNDED_LATTICE_PLANNER_ROS_H