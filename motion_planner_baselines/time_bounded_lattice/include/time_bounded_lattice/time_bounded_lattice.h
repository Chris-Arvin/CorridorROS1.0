#ifndef TIME_BOUNDED_LATTICE_PLANNER_TIME_BOUNDED_LATTICE_PLANNER_H
#define TIME_BOUNDED_LATTICE_PLANNER_TIME_BOUNDED_LATTICE_PLANNER_H
...
{
class TimeBoundedLattice
{
public:
  TimeBoundedLattice(base_local_planner::CostmapModel* costmap_model,
...
#endif  // TIME_BOUNDED_LATTICE_PLANNER_TIME_BOUNDED_LATTICE_PLANNER_H