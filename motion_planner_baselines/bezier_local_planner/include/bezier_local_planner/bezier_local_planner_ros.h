#ifndef BEZIER_LOCAL_PLANNER_BEZIER_LOCAL_PLANNER_ROS_H
#define BEZIER_LOCAL_PLANNER_BEZIER_LOCAL_PLANNER_ROS_H
...
{
class BezierLocalPlannerROS : public nav_core::BaseLocalPlanner
{
public:
  /**
   * @brief Default constructor of the bezier local planner plugin
   */
  BezierLocalPlannerROS();

  /**
   * @brief  Destructor of the plugin
   */
  virtual ~BezierLocalPlannerROS();
...
private:
  ...
  BezierConfig cfg_;
  BezierLocalPlanner* planner_;
};

}  // namespace bezier_local_planner

#endif  // BEZIER_LOCAL_PLANNER_BEZIER_LOCAL_PLANNER_ROS_H